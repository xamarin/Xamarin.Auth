...
Skydrive uses OAuth 2.0 authentication, so we create an `OAuth2Authenticator`. Authenticators are responible for managing the user interface presented to the user and interacting with services to get them authenticated.
